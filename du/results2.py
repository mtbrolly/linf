...
def results(model_dir, checkpoint_file):
    ...
    def s3(x): return gm.S3(x, sample_size=200000)  # !!!, block_size=100)
    ...
    plt.yscale('log')
    plt.tight_layout()
    plt.savefig(figures_dir + second_training_prefix + "S1_loglog.png",
                dpi=576)
    plt.close()
    ...
    plt.yscale('log')
    plt.tight_layout()
    plt.savefig(figures_dir + second_training_prefix + "S2_loglog.png",
                dpi=576)
    plt.close()
    ...
    plt.legend()
    plt.tight_layout()
    plt.savefig(figures_dir + second_training_prefix + "S3.png", dpi=576)
    plt.xscale('log')
    plt.yscale('log')
    plt.tight_layout()
    plt.savefig(figures_dir + second_training_prefix + "S3_loglog.png",
                dpi=576)
    plt.close()
    ...
    plt.legend()
    plt.tight_layout()
    plt.savefig(figures_dir + second_training_prefix + "S3_abs.png", dpi=576)
    plt.xscale('log')
    plt.yscale('log')
    plt.tight_layout()
    plt.savefig(figures_dir + second_training_prefix + "S3_abs_loglog.png",
                dpi=576)
    plt.close()
    ...
    plt.legend()
    plt.tight_layout()
    plt.savefig(figures_dir + second_training_prefix + "skew.png", dpi=576)
    plt.close()
    ...
    plt.legend()
    # plt.tight_layout()
    # plt.savefig(figures_dir + second_training_prefix + "kurt.png", dpi=576)
    plt.xscale('log')
    plt.yscale('log')
    plt.tight_layout()
    plt.savefig(figures_dir + second_training_prefix + "kurt_loglog.png",
                dpi=576)
    plt.close()
